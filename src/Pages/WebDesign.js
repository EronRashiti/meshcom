...
import SS1 from '../Assets/mesh-com-web-design-img.webp';
                    ...
                    <NavBar />
                        <div className="single-service-hero-content">
                            <div className="single-service-text-content">
                                <h1 id="single-service-title">Web<br/>Design</h1>
                            ...
                            <div class="single-service-images">
                                <img id="single-images" src={SS1} alt="mesh-com-web-design-img"></img>
                        </div>
                </div>
        </section>
