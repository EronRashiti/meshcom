        ...
        <div>
            <div className="elements-show">
                <button onClick={()=>setShow1(!show1)} className="elements">
                    ...
                    <button className="show-btn" onClick={()=>setShow1(!show1)}><img src={DotsBtn} alt=""></img></button>
                </button>
                {
            ...
            <div className="elements-show">
                <button onClick={()=>setShow2(!show2)} className="elements">
                    ...
                    <button className="show-btn" onClick={()=>setShow2(!show2)}><img src={DotsBtn} alt=""></img></button>
                </button>
                {
            ...
            <div className="elements-show">
                <button onClick={()=>setShow3(!show3)} className="elements">
                    ...
                    <button className="show-btn" onClick={()=>setShow3(!show3)}><img src={DotsBtn} alt=""></img></button>
                </button>
                {
            ...
            <div className="elements-show">
                <button onClick={()=>setShow4(!show4)} className="elements">
                    ...
                    <button className="show-btn" onClick={()=>setShow4(!show4)}><img src={DotsBtn} alt=""></img></button>
                </button>
                {
            ...
            <div className="elements-show">
                <button onClick={()=>setShow5(!show5)} className="elements">
                    ...
                    <button className="show-btn" onClick={()=>setShow5(!show5)}><img src={DotsBtn} alt=""></img></button>
                </button>
                {
            ...
            <div className="elements-show">
                <button onClick={()=>setShow6(!show6)} className="elements">
                    ...
                    <button className="show-btn" onClick={()=>setShow6(!show6)}><img src={DotsBtn} alt=""></img></button>
                </button>
                {
